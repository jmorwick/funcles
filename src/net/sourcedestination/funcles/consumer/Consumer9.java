 ...
 */
@FunctionalInterface
public interface Consumer9<A1, A2, A3, A4, A5, A6, A7, A8, A9> extends Consumer<Tuple9<A1, A2, A3, A4, A5, A6, A7, A8, A9>> {
	
	default void accept(Tuple9<A1, A2, A3, A4, A5, A6, A7, A8, A9> args) {
		accept(args._1, args._2, args._3, args._4, args._5, args._6, args._7, args._8, args._9);
	}
	
	void accept(A1 arg1, A2 arg2, A3 arg3, A4 arg4, A5 arg5, A6 arg6, A7 arg7, A8 arg8, A9 arg9);
	
	default Consumer9<A1, A2, A3, A4, A5, A6, A7, A8, A9> applyHigherOrderTo(Function< ? super Consumer9<A1, A2, A3, A4, A5, A6, A7, A8, A9>,
				                                                ? extends Consumer<Tuple9<A1, A2, A3, A4, A5, A6, A7, A8, A9>>> hof) {
		return toConsumer9(hof.apply(this));
	}
	
	static <A1, A2, A3, A4, A5, A6, A7, A8, A9> Consumer9<A1, A2, A3, A4, A5, A6, A7, A8, A9>
