 ...
 */
@FunctionalInterface
public interface Function5<A1, A2, A3, A4, A5, R> extends Function<Tuple5<A1, A2, A3, A4, A5>, R> {
	default R apply(Tuple5<A1, A2, A3, A4, A5> args) {
	...
	default Function4<A2, A3, A4, A5, R> bind1(A1 arg) {
	    return (a2, a3, a4, a5) -> apply(arg, a2, a3, a4, a5);
	}
	
	default Function4<A1, A3, A4, A5, R> bind2(A2 arg) {
	    return (a1, a3, a4, a5) -> apply(a1, arg, a3, a4, a5);
	}
	
	default Function4<A1, A2, A4, A5, R> bind3(A3 arg) {
	    return (a1, a2, a4, a5) -> apply(a1, a2, arg, a4, a5);
	}
	
	default Function4<A1, A2, A3, A5, R> bind4(A4 arg) {
	    return (a1, a2, a3, a5) -> apply(a1, a2, a3, arg, a5);
	}
	
	default Function4<A1, A2, A3, A4, R> bind5(A5 arg) {
	    return (a1, a2, a3, a4) -> apply(a1, a2, a3, a4, arg);
	}
	
	static <A1, A2, A3, A4, A5,R> Function5<A1, A2, A3, A4, A5,R>
