...
public abstract interface Function4<A1, A2, A3, A4, R> extends Function<Tuple4<A1, A2, A3, A4>, R> {
	...
	public default Function3<A2, A3, A4, R> bind1(A1 arg) {
	    return (a2, a3, a4) -> apply(arg, a2, a3, a4);
	}
	
	public default Function3<A1, A3, A4, R> bind2(A2 arg) {
	    return (a1, a3, a4) -> apply(a1, arg, a3, a4);
	}
	
	public default Function3<A1, A2, A4, R> bind3(A3 arg) {
	    return (a1, a2, a4) -> apply(a1, a2, arg, a4);
	}
	
	public default Function3<A1, A2, A3, R> bind4(A4 arg) {
