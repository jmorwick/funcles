...
public abstract interface Function10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, R> extends Function<Tuple10<A1, A2, A3, A4, A5, A6, A7, A8, A9, A10>, R> {
	...
	public default Function9<A2, A3, A4, A5, A6, A7, A8, A9, A10, R> bind1(A1 arg) {
	    return (a2, a3, a4, a5, a6, a7, a8, a9, a10) -> apply(arg, a2, a3, a4, a5, a6, a7, a8, a9, a10);
	}
	
	public default Function9<A1, A3, A4, A5, A6, A7, A8, A9, A10, R> bind2(A2 arg) {
	    return (a1, a3, a4, a5, a6, a7, a8, a9, a10) -> apply(a1, arg, a3, a4, a5, a6, a7, a8, a9, a10);
	}
	
	public default Function9<A1, A2, A4, A5, A6, A7, A8, A9, A10, R> bind3(A3 arg) {
	    return (a1, a2, a4, a5, a6, a7, a8, a9, a10) -> apply(a1, a2, arg, a4, a5, a6, a7, a8, a9, a10);
	}
	
	public default Function9<A1, A2, A3, A5, A6, A7, A8, A9, A10, R> bind4(A4 arg) {
	    return (a1, a2, a3, a5, a6, a7, a8, a9, a10) -> apply(a1, a2, a3, arg, a5, a6, a7, a8, a9, a10);
	}
	
	public default Function9<A1, A2, A3, A4, A6, A7, A8, A9, A10, R> bind5(A5 arg) {
	    return (a1, a2, a3, a4, a6, a7, a8, a9, a10) -> apply(a1, a2, a3, a4, arg, a6, a7, a8, a9, a10);
	}
	
	public default Function9<A1, A2, A3, A4, A5, A7, A8, A9, A10, R> bind6(A6 arg) {
	    return (a1, a2, a3, a4, a5, a7, a8, a9, a10) -> apply(a1, a2, a3, a4, a5, arg, a7, a8, a9, a10);
	}
	
	public default Function9<A1, A2, A3, A4, A5, A6, A8, A9, A10, R> bind7(A7 arg) {
	    return (a1, a2, a3, a4, a5, a6, a8, a9, a10) -> apply(a1, a2, a3, a4, a5, a6, arg, a8, a9, a10);
	}
	
	public default Function9<A1, A2, A3, A4, A5, A6, A7, A9, A10, R> bind8(A8 arg) {
	    return (a1, a2, a3, a4, a5, a6, a7, a9, a10) -> apply(a1, a2, a3, a4, a5, a6, a7, arg, a9, a10);
	}
	
	public default Function9<A1, A2, A3, A4, A5, A6, A7, A8, A10, R> bind9(A9 arg) {
	    return (a1, a2, a3, a4, a5, a6, a7, a8, a10) -> apply(a1, a2, a3, a4, a5, a6, a7, a8, arg, a10);
	}
	
	public default Function9<A1, A2, A3, A4, A5, A6, A7, A8, A9, R> bind10(A10 arg) {
